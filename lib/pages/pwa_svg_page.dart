...
const String copyIconString = '''
<svg width="33" height="33" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M22.7778 16.3007L25.1167 13.9618C26.6954 12.3831 26.6954 9.82338 25.1167 8.24462C23.5379 6.66586 20.9782 6.66586 19.3995 8.24462L16.3963 11.2478C12.3959 15.2742 20.7277 18.3726 16.9084 22.1701L14.202 24.8765C12.6233 26.4552 10.0636 26.4552 8.48485 24.8765C6.90609 23.2977 6.90609 20.738 8.48485 19.1593L10.304 17.3402" stroke="#1A212A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>

''';

const String timeIconString = '''
<svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M5.99763 4.61538V7.03846M4.7861 1.5L7.38225 1.5M9.80533 6.69231C9.80533 8.79524 8.10057 10.5 5.99763 10.5C3.8947 10.5 2.18994 8.79524 2.18994 6.69231C2.18994 4.58938 3.8947 2.88462 5.99763 2.88462C8.10057 2.88462 9.80533 4.58938 9.80533 6.69231Z" stroke="#63717B" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
''';
          ...
          SliverList(
            delegate: SliverChildBuilderDelegate(
              (BuildContext context, int index) {
                ...
                // ? Center(
                //     child:
                //         _ActionIconBg(icon: ScalableImageWidget(si: ScalableImage.fromSvgString(copyIconString))),
                //   )
                // ? Center(
                //     child: _ActionIconBg(
                //         icon: SvgPicture.asset(
                ...
                //             si: ScalableImage.fromSvgString(timeIconString, bigFloats: true, compact: true))),
                //   );
              },
              // 40 list items
              childCount: 70,
